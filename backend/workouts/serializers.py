...
class WorkoutSessionSerializer(serializers.ModelSerializer):
    ...
    workout_day_id = serializers.PrimaryKeyRelatedField(queryset=WorkoutDay.objects.all(), source='workout_day', write_only=True)
    ...
    class Meta:
        ...
        read_only_fields = ['id', 'created_at', 'updated_at', 'workout_day', 'exercise_sets'] 